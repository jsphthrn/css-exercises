...
- Does each element have a unique class name? JY: Yes.
- Did you use the grouping selector for styles that both elements share? JY: Yes.
- Did you make separate rules for the styles unique to each element? JY: Yes.
