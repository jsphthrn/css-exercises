...
### Self Check
- Did you properly chain class selectors for each rule? JY: Yes.
- Does the `proportioned` image retain its original square proportions? JY: Yes.
- Does the `distorted` image end up looking squished and, well, distorted? JY: Yes.
